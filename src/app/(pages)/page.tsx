  ...
  return (
    <main className="flex flex-col min-h-screen bg-background">
      ...
      <section
        ...
        className="relative min-h-[70vh] md:min-h-[84vh] flex items-center justify-center text-center text-white overflow-hidden"
      >
        <Image
        ...
        <div className="relative z-10 container px-6">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-200 mb-8 max-w-2xl mx-auto font-light">
              Plan your spiritual journey to Vrindavan & Mathura — temples,
              festivals, and trusted guides.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/places">
                <Button
                  size="lg"
                  className="w-full sm:w-auto text-lg px-8  backdrop-blur cursor-pointer"
                >
                  Explore Places
                </Button>
              </Link>
              <Link href="/planner">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto cursor-pointer text-lg px-8 bg-white/10 backdrop-blur border-white/40 text-white hover:bg-white hover:text-black"
                >
                  Plan Trip
                </Button>
              </Link>
        ...
        <div className="flex justify-between items-end mb-8">
          <div>
            <h2 className="text-3xl font-serif font-bold">
              Popular Temples & Ghats
            </h2>
            <p className="text-muted-foreground mt-2">
              Most visited spiritual destinations in Braj
            </p>
          </div>
      ...
      {/* ================= FESTIVALS ================= */}
      <section
        className="py-16 bg-linear-to-b from-orange-50/40 to-transparent"
        ...
        <div className="container px-6">
          <div className="flex justify-between items-end mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Celebrate with devotion and colors
              </p>
            </div>
      ...
      {/* ================= HOW IT WORKS ================= */}
      <section
        className="py-20 container px-6 text-center"
        aria-labelledby="how-heading"
      >
        <h2 id="how-heading" className="text-3xl font-serif font-bold mb-10">
          How BrajDarshan Works
        </h2>
      ...
      <section className="py-20 bg-secondary text-secondary-foreground">
        <div className="container px-6 text-center max-w-2xl mx-auto">
          ...
          <p className="mb-6 text-secondary-foreground/85">
            Join our newsletter for festival alerts, darshan timings, and travel
            tips.
          </p>
          ...
          <p
            id="newsletter-msg"
            className={`mt-3 text-sm ${status === "error" ? "text-destructive" : "text-foreground/80"}`}
          >
            {message}
          </p>
        </div>
